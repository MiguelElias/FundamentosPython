...
main()
'''
A função main, é responsavel por chamar a função teste() e a turtle.done() Inicia o loop de evento,
dentro da fução teste() temos 3 chamadas da função desenhaPoligono() que faz
o deseho a tela de dois quadrados e um triangulo o primeiro e segundo parametro da função
referem se ao posicionamento e os demais na cor de borda e de recheio dos elementos criados 
'''
